...
func helpContent() string {
	lines := []string{
		...
		"  s       Sync rápido com origin (quando behind)",
		"  S       Sync com opções (prune, base, etc.)",
		...
		"",
		"Na tela de branches",
		"  n       Nova branch (from → template → nome)",
		"  Enter   Checkout da branch selecionada",
		"",
		"Na tela de sync (S)",
		"  ↑↓      Escolher modo (padrão / prune remoto / prune completo)",
		"  b       Editar branch base",
		"  Enter   Executar sync",
		"",
		"Na tela de add",
